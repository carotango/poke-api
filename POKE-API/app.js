...
const displayImage = url => {
    // Selecciono el elemento de la imagen y le seteo el valor al src para que lo dibuje, asi evito que cree muchas imagenes
...
const showError = () => {
    ...
    document.getElementById("msj").innerText = "INEXISTENTE 🤬"
